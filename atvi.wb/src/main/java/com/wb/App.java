...
public class App {
	public static void main(String[] args) {
		...
		while (execucao) {
			...
			System.out.println("5 - Carrinho de itens");
			...
			case 2:
				Execucao Listar = new Listagens(empresa);
				Listar.executar();
			break;
			...
			break;	
			case 5:
				Execucao Carrinho = new Carro(empresa);
				Carrinho.executar();
			break;
			case 6:
				Execucao outraListagem = new ListagensII(empresa);

...
public class ListarGenero extends Listagem{
	
	private List<Cliente> clientes;
	
	int i = 0;
	
	public ListarGenero(List<Cliente> clientes) {
	...
	public void listar() {	
		...
		while (true) {
			...
			case 1:
				if (clientes.size() == 0) {
					System.out.println("Não há clientes do gênero Masculino cadastrados para esse tipo de listagem!");
					break;
				}
			...
			case 2:
				if (clientes.size() == 0) {
					System.out.println("Não há clientes do gênero Feminino cadastrados para esse tipo de listagem!");
					break;
				}

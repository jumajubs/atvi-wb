...
public class ListarCliMenos extends Listagem{
	private List<Cliente> clientes;
    Map <String, Integer> dict = new HashMap<>();
	int i = 0;
	
	public ListarCliMenos(List<Cliente> clientes) {
	...
	public void listar() {	
		...
		while (true) {
			...
			System.out.println("\nListagem dos 10 clientes que menos consumiram Produtos/Serviços por quantidade:");

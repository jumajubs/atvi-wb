...
public class ListarCGenero extends Listagem{
	private List<Cliente> clientes;
	int i = 0;
	
	public ListarCGenero(List<Cliente> clientes) {
	...
	public void listar() {	
		...
		while (true) {
			...
			if (clientes.size() == 0) {
				System.out.println("Não há clientes cadastrados para este tipo de listagem!");
				break;
	        }
			...
			case 1:
					if (clientes.size() == 0) {
						System.out.println("Não há clientes Masculinos cadastrados para este tipo de listagem!");
					}
					...
					for (Cliente cliente : clientes) {
						if (cliente.getGenero().equals("Masculino")) {
							...
							for (ProdConsumido produtosConsumidos: clientes.get(i).getProdutosConsumidos()) {
			        ...
			        Collections.sort(listMP, new Comparator<Object>() {
			           ...
			           for(String i : resultMP.keySet()) {
				           ...
				           System.out.println("\nO produto mais consumido pelo Gênero Masculino é " + i + " com " + primeiro + " consumos.");
			               break;
			           }
		            ...
		            /* SERVIÇOS MASCULINOS MAIS CONSUMIDOS*/
					 ...
					 for (Cliente cliente : clientes) {
						 if (cliente.getGenero().equals("Masculino")) {
							 ...
							 for (ServConsumido servicosConsumidos: clientes.get(i).getServicosConsumidos()) {
			...
			case 2:
				System.out.println("Não há clientes Femininos cadastrados para este tipo de listagem!");
				i=0;
				for (Cliente cliente : clientes) {
		         ...
		         Collections.sort(listFP, new Comparator<Object>() {
		            ...
		            for(String i : resultFP.keySet()) {
			            ...
			            System.out.println("\nO produto mais consumido pelo Gênero Feminino é " + i + " com " + primeiro + " consumos.");
		                break;
		            }

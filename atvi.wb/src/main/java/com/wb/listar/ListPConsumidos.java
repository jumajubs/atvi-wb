...
public class ListPConsumidos extends Listagem {
	private List<Cliente> clientes;
	int i=0;
	int x=0;

	public ListPConsumidos(List<Cliente> clientes) {
	...
	public void listar() {
		while (true) {
			...
			for (ProdConsumido produtosConsumidos: clientes.get(numCli).getProdutosConsumidos()) {

...
public class ListSConsumidos extends Listagem {
	private List<Cliente> clientes;
	int i=0;
	int x=0;
	
	public ListSConsumidos(List<Cliente> clientes) {
	...
	public void listar() {
		while (true) {
			...
			for (ServConsumido servicosConsumidos: clientes.get(numCli).getServicosConsumidos()) {

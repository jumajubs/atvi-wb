		...
		while ( edit ) {
			...
			case 1:									
				...
				while (ope) {
					...
					System.out.println("Número de cliente inválido! Verifique e digite novamente.");
				...
				case 3:
					...
					while (true) {
						...
						System.out.println("Número de RG inválido! Verifique e digite novamente.");
					}
				...
				case 4:
					...
					while (true) {
						...
						System.out.println("Número de Telefone inválido! Verifique e digite novamente.");
					}
			...
			case 2:
				...
				while (true) {
					...
					System.out.println("Número de produto inválido! Verifique e digite novamente.");
				}
			...
			case 3:
				...
				while (true) {
					...
					System.out.println("Número de serviço inválido! Verifique e digite novamente.");
				}
